...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <!-- Card Body -->
        <div class="card-body">
            <form class="user" action="/admin/saverule" method="POST">
                <?= csrf_field(); ?>

                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Kode Rule</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="trule" name="trule" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="tgejala" name="tgejala" required>
                    </div>
                </div>
