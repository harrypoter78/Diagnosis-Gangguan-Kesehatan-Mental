...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <!-- Card Body -->
        <div class="card-body">
            <form class="user" action="/admin/savepenyakit" method="POST">
                <?= csrf_field(); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="tdeskripsi" name="tdeskripsi" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Solusi Obat</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="tobat" name="tobat" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Solusi Lain</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="tlain" name="tlain" required>
                    </div>
                </div>
